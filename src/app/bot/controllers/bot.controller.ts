...
export class BotController {
  ...
  constructor(
    private botHandlerService: BotHandlerService,
  ) {
  ...
  public async botFrameworkMessages(@Req() req) {
    ...
    await this.botFrameworkAdapter.processActivity(req, res, (turnContext: TurnContext) => this.botHandlerService.run(turnContext));
    return body;
  }
}
